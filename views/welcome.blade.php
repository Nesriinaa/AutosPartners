    ...
    <section id="footer-area">
        ...
        <div class="footer-bottom-area">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. <i class="fa fa-heart-o" aria-hidden="true"></i>-->
                        &copy;<script>document.write(new Date().getFullYear());</script> Tous droits réservés | Créé par l'équipe d'AutosPartners avec <a href="https://colorlib.com" target="_blank">Colorlib</a>
